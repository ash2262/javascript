	...
	boomr = {
		...
		utils: {
			...
			hashQueryString: function(url, stripHash) {
				...
				//return "?" + (m1.length > 10 ? BOOMR.utils.MD5(m1) : m1);  Change Date: 6th June 2020
					return "?" + (m1.length > 10 ? SHA1(m1) : m1);
				});
			},
...
//added below function for SHA1 ecnryption.
Change Date: 6th June 2020 
function SHA1(text) {
